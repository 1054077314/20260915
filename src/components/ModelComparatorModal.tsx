      ...
      {isOpen && models.length > 0 && modelA && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-4xl bg-[#09090e] border border-white/12 rounded-2xl shadow-[0_25px_70px_rgba(0,0,0,0.85)] p-6 sm:p-8 my-8 z-10"
              ...
              {[modelA, modelB].map((m, idx) => (
                <div key={idx} className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.08]">
                  ...
                  <select
                    ...
                    className="w-full bg-[#14141a] border border-white/10 text-white rounded-lg p-2.5 text-base font-medium focus:outline-none focus:border-amber-400 cursor-pointer"
                  >
                    {allModels.map((opt) => (
